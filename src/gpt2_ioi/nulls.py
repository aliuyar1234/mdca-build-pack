...
from .model import FAMILY_CANONICAL, GPT2IOIModel
from .scoring import (
...
def shuffled_pair_is_available(dataset_bundle: S3DatasetBundle) -> bool:
...
def build_shuffled_pair_dataset_bundle(
    ...
    *,
    ...
    return S3DatasetBundle(tuples=tuple(shuffled_records), split_by_group=split_by_group)
...
def run_random_site_null_search(
    *,
    ...
    engine = GPT2IOICandidateSearchEngine(
        model=model,
